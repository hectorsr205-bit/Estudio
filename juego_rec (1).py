...
class Juego:
    ...
    def determinar_ganador( self,eleccion_jugador,eleccion_ordenador ):
        ...
        if eleccion_jugador==eleccion_ordenador: return "Empate"
        elif ((eleccion_jugador=="piedra" and eleccion_ordenador=="tijera") or (eleccion_jugador=="papel" and eleccion_ordenador=="piedra") or (eleccion_jugador=="tijera" and eleccion_ordenador=="papel")):
